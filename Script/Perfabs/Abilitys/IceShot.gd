...
func _ready() -> void:
    ...
    _damage_data.frost_damage = (actor.output_data.damage * 2.4) * 0.2
    ...
    _new_ball.hited_function = func():
        ...
        _damage_data2.damage = (actor.output_data.damage * 1.2) * 0.8
        _damage_data2.frost_damage = (actor.output_data.damage * 1.2) * 0.2
